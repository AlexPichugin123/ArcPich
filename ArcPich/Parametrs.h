...
static std::vector<POINT> tracePoints;
static std::vector<POINT> predictedPoints; // точки прогнозируемой траектории
const int PREDICTION_STEPS = 80; // количество шагов прогнозирования